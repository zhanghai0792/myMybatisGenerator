...
public class deleteTemplate {
 ...
 private static String deleteById_id_content="\r\n<delete id=\"%s\" parameterType=\"java.lang.Integer\">\r\ndelete from %s where id = #{id,jdbcType=INTEGER}\r\n</delete>\r\n";
 private static String deleteByIds_id_content="\r\n<delete id=\"%s\">\r\ndelete from %s\r\nwhere id in <foreach collection=\"list\" item=\"i\" open=\"(\" close=\")\" separator=\",\">#{i}</foreach>\r\n  </delete>\r\n";
 private static String deleteByObjects_id_content="\r\n<delete id=\"%s\">\r\ndelete from %s\r\nwhere id in <foreach collection=\"list\" item=\"i\" open=\"(\" close=\")\" separator=\",\">#{i.id,jdbcType=INTEGER}</foreach>\r\n  </delete>\r\n";
 ...
 public static String getdeleteByObjects(String tableName){
		return String.format(deleteByObjects_id_content, deleteByObjects_id,tableName);
	}
}
